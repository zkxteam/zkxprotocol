...
async def adminAuth_factory(starknet_service: StarknetService):
    ...
    return adminAuth, fees, admin1, admin2, asset, trading, alice, bob, dave, fixed_math, holding, feeBalance, account_registry, withdrawal_request


@pytest.mark.asyncio
async def test_registering_of_users(adminAuth_factory):
    adminAuth, fees, admin1, admin2, asset, trading, alice, bob, dave, fixed_math, holding, feeBalance, account_registry, withdrawal_request = adminAuth_factory
