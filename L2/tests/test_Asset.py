...
async def test_adding_asset_by_admin(adminAuth_factory):
    ...
    await signer1.send_transaction(admin1, asset.contract_address, 'addAsset', [str_to_felt("32f0406jz7qj8"), 0, str_to_felt("ETH"), str_to_felt("Ethereum"), 0, 0, 18, 0, 1, 1, 1, 10, 1, 5, 3, 1, 1, 1, 100, 1000, 10000])
...
async def test_adding_asset_by_unauthorized_user(adminAuth_factory):
    ...
    assert_revert(lambda: signer3.send_transaction(user1, asset.contract_address, 'addAsset', [str_to_felt(
        "32f0406jz7qj8"), 0, str_to_felt("ETH"), str_to_felt("Ethereum"), 0, 0, 18, 0, 1, 1, 1, 10, 1, 5, 3, 1, 1, 1, 100, 1000, 10000]))
...
async def test_modifying_asset_by_admin(adminAuth_factory):
    ...
    await signer1.send_transaction(admin1, asset.contract_address, 'modify_core_settings', [str_to_felt("32f0406jz7qj8"), str_to_felt("ETHEREUM"), 1, 1, 10, 1, 2])
...
async def test_modifying_asset_by_unauthorized_user(adminAuth_factory):
    ...
    assert_revert(lambda: signer3.send_transaction(user1, asset.contract_address, 'modify_core_settings', [
                  str_to_felt("32f0406jz7qj8"), str_to_felt("ETH"), str_to_felt("Ethereum"), 0, 1, 18, 1, 2]))
...
async def test_retrieve_assets(adminAuth_factory):
    ...
    await signer1.send_transaction(admin1, asset.contract_address, 'addAsset', [str_to_felt("32f0406jz7qk90"), 0, str_to_felt("TSLA"), str_to_felt("Tesla"), 0, 0, 18, 0, 1, 1, 1, 10, 1, 5, 3, 1, 1, 1, 100, 1000, 10000])
