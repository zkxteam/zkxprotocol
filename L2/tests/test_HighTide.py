...
from utils import Signer, uint, str_to_felt, MAX_UINT256, assert_revert, to64x61, PRIME, assert_event_emitted, assert_events_emitted, hash_order
...
async def adminAuth_factory(starknet_service: StarknetService):
    ...
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [5, 1, trading.contract_address])
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [6, 1, feeBalance.contract_address])
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [7, 1, holding.contract_address])
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [8, 1, emergency.contract_address])
    ...
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [11, 1, liquidate.contract_address])
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [14, 1, account_registry.contract_address])
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [21, 1, marketPrices.contract_address])
    ...
    await signer1.send_transaction(admin1, registry.contract_address, 'update_contract_registry', [26, 1, user_stats.contract_address])
    ...
    await signer1.send_transaction(admin1, account_registry.contract_address, 'add_to_account_registry',[admin1.contract_address])
    await signer1.send_transaction(admin1, account_registry.contract_address, 'add_to_account_registry',[admin2.contract_address])
    await signer1.send_transaction(admin1, account_registry.contract_address, 'add_to_account_registry',[alice.contract_address])
    await signer1.send_transaction(admin1, account_registry.contract_address, 'add_to_account_registry',[bob.contract_address])
    await signer1.send_transaction(admin1, account_registry.contract_address, 'add_to_account_registry',[charlie.contract_address])
    await signer1.send_transaction(admin1, account_registry.contract_address, 'add_to_account_registry',[dave.contract_address])
    ...
    await signer1.send_transaction(admin1, alice.contract_address, 'set_balance', [USDC_ID, to64x61(100000)])
    await signer1.send_transaction(admin1, bob.contract_address, 'set_balance', [USDC_ID, to64x61(100000)])

    return adminAuth, admin1, admin2, user1, alice, bob, charlie, dave, native_erc20_usdc, native_erc20_ust, starkway, starknet_service, trading, hightide, hightideCalc

@pytest.mark.asyncio
async def test_set_multipliers_unauthorized_user(adminAuth_factory):
    adminAuth, admin1, admin2, user1, alice, bob, charlie, dave, native_erc20_usdc, native_erc20_ust, starkway, starknet_service, trading, hightide, hightideCalc = adminAuth_factory
...
async def test_setup_trading_season_unauthorized_user(adminAuth_factory):
    ...
    await assert_revert( 
        signer3.send_transaction(user1, hightide.contract_address, 'setup_trade_season', [initial_timestamp, 30]),
...
async def test_placing_orders_day_0(adminAuth_factory):
    ...
    await assert_revert(signer1.send_transaction(admin1, hightideCalc.contract_address, "calculate_w", [
        season_id,
        pair_id,
        2,
    ...
    await assert_revert(signer1.send_transaction(admin1, hightideCalc.contract_address, "calculate_trader_score", [
        season_id,
        pair_id,
        2,
        alice.contract_address,
...
#     await signer1.send_transaction(admin1, charlie.contract_address, 'set_balance', [AssetID.USDC, charlie_balance])
#     # increment to next day
#     starknet_service.starknet.state.state.block_info = BlockInfo(
#         block_number=1, 
...
#     await signer1.send_transaction(admin1, hightide.contract_address,"end_trade_season",[season_id])
#     await signer1.send_transaction(admin1, rewardsCalculation.contract_address,"set_user_xp_values",
#             [
#                 season_id,
#                 3,
#                 alice.contract_address,
...
#     await signer1.send_transaction(admin1, hightideCalc.contract_address, "calculate_funds_flow", [
#         season_id
#     ])

#     await signer1.send_transaction(admin1, hightideCalc.contract_address, "calculate_w", [
#         season_id,
#         ETH_USD_ID,
#         2,
#         alice.contract_address,
...
#     await signer1.send_transaction(admin1, hightideCalc.contract_address, "calculate_trader_score", [
#         season_id,
#         ETH_USD_ID,
#         2,
#         alice.contract_address,
