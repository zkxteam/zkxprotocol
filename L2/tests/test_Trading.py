...
async def adminAuth_factory():
    ...
    val = await fixed_math.Math64x61_mul(2236667718937283072, 4611686018427387904).call()
    print(val)
...
#     fees1 = await fixed_math.Math64x61_mul(amount1.result.res, short_trading_fees).call()
#     total_amount1 = amount1.result.res + fees1.result.res

#     amount2 = await fixed_math.Math64x61_mul(execution_price1, size1).call()
#     fees2 = await fixed_math.Math64x61_mul(amount2.result.res, long_trading_fees).call()
...
async def test_opening_and_closing_full_orders(adminAuth_factory):
    ...
    fees2 = await fixed_math.Math64x61_mul(amount2.result.res, short_trading_fees).call()
    total_amount2 = amount2.result.res - fees2.result.res
    ...
    fees1 = await fixed_math.Math64x61_mul(amount1.result.res, long_trading_fees).call()
    total_amount1 = amount1.result.res - fees1.result.res
    ...
    res = await dave_signer.send_transaction(dave, trading.contract_address, "execute_batch", [
        ...
        alice.contract_address, signed_message3[0], signed_message3[
            1], order_id_3, assetID_3, collateralID_3, price3, orderType3, position3, direction3, closeOrder3, leverage3, isLiquidation3, liquidatorAddress3, parentOrder3, 0,
        bob.contract_address, signed_message4[0], signed_message4[
            1], order_id_4, assetID_4, collateralID_4, price4, orderType4, position4, direction4, closeOrder4, leverage4, isLiquidation4, liquidatorAddress4, parentOrder4, 1,
    ])
...
#     fees3 = await fixed_math.Math64x61_mul(amount3.result.res, long_trading_fees).call()
...
#     fees3 = await fixed_math.Math64x61_mul(amount3.result.res, short_trading_fees).call()
#     total_amount3 = amount3.result.res - fees3.result.res
...
#     fees1 = await fixed_math.Math64x61_mul(amount_for_fee1.result.res, short_trading_fees).call()
#     total_amount1 = amount1.result.res + fees1.result.res
...
#     fees2 = await fixed_math.Math64x61_mul(amount_for_fee2.result.res, long_trading_fees).call()
#     total_amount2 = amount2.result.res + fees2.result.res
...
#     fees1 = await fixed_math.Math64x61_mul(amount_for_fee1.result.res, long_trading_fees).call()
#     total_amount1 = amount1.result.res + fees1.result.res
...
#     fees2 = await fixed_math.Math64x61_mul(amount_for_fee2.result.res, short_trading_fees).call()
#     total_amount2 = amount2.result.res + fees2.result.res
