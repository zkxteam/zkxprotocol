...
async def adminAuth_factory(starknet_service: StarknetService):
    ...
    print("liquidity :", hex(liquidity.contract_address))
    print("insurance :" , hex(insurance.contract_address))
    print("emergency :", hex(emergency.contract_address))
    print("trading :", hex(trading.contract_address))
    print("feeDiscount :", hex(feeDiscount.contract_address))
    print("marketPrices :", hex(marketPrices.contract_address))
...
#     orderState4 = await bob.get_position_data(market_id_=marketID_2, direction_=direction1).call()
#     res4 = list(orderState4.result.res)
