...
async def adminAuth_factory(starknet_service: StarknetService):
    ...
    await signer1.send_transaction(admin1, adminAuth.contract_address, 'update_admin_mapping', [relay_asset.contract_address, ManagerAction.ManageAssets, True])
    await signer1.send_transaction(admin1, adminAuth.contract_address, 'update_admin_mapping', [relay_market.contract_address, ManagerAction.ManageMarkets, True])
    ...
    async def add_asset(id, name, is_tradable, is_collateral, decimals):
        ...
        await signer1.send_transaction(admin1, relay_asset.contract_address, 'add_asset', asset_properties)
