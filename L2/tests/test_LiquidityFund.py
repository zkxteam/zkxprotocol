...
#     assert_revert(lambda: signer3.send_transaction(pytest.user1,liquidity.contract_address, 'fund', [ str_to_felt("USDC"), 100]))
...
#     assert_revert(lambda: signer3.send_transaction(pytest.user1,liquidity.contract_address, 'defund', [ str_to_felt("USDC"), 100]))