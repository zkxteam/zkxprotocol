...
async def test_set_abr_1(abr_factory):
    starknet_service, non_admin, admin1, trading, fixed_math, alice,  bob, charlie, dave, abr_calculations, relay_abr, abr_core, abr_fund, abr_payment, timestamp, admin2, alice_test, bob_test, charlie_test, dave_test, python_executor, abr_executor = abr_factory
    # Set BTC_USD ABR
    (set_abr_value_tx, abr_value, abr_last_price) = await set_abr_value(market_id=BTC_USD_ID, node_signer=admin1_signer, node=admin1, abr_core=relay_abr, abr_executor=abr_executor, timestamp=from64x61(timestamp_1), spot=ABR_data.btc_usd_perp_spot_1, perp=ABR_data.btc_usd_perp_1, spot_64x61=convertTo64x61(ABR_data.btc_usd_perp_spot_1), perp_64x61=convertTo64x61(ABR_data.btc_usd_perp_1), epoch=1, base_rate=0.0000125, boll_width=2.0)
...
async def test_set_abr_2(abr_factory):
    starknet_service, non_admin, admin1, trading, fixed_math, alice,  bob, charlie, dave, abr_calculations, relay_abr, abr_core, abr_fund, abr_payment, timestamp, admin2, alice_test, bob_test, charlie_test, dave_test, python_executor, abr_executor = abr_factory
    # Set ETH_USD ABR
    (set_abr_value_tx, abr_value, abr_last_price) = await set_abr_value(market_id=ETH_USD_ID, node_signer=admin1_signer, node=admin1, abr_core=relay_abr, abr_executor=abr_executor, timestamp=from64x61(timestamp_1), spot=ABR_data.eth_usd_perp_spot_1, perp=ABR_data.eth_usd_perp_1, spot_64x61=convertTo64x61(ABR_data.eth_usd_perp_spot_1), perp_64x61=convertTo64x61(ABR_data.eth_usd_perp_1), epoch=1, base_rate=0.0000125, boll_width=2.0)
...
async def test_set_abr_3(abr_factory):
    starknet_service, non_admin, admin1, trading, fixed_math, alice,  bob, charlie, dave, abr_calculations, relay_abr, abr_core, abr_fund, abr_payment, timestamp, admin2, alice_test, bob_test, charlie_test, dave_test, python_executor, abr_executor = abr_factory
    # Set BTC_UST ABR
    (set_abr_value_tx, abr_value, abr_last_price) = await set_abr_value(market_id=BTC_UST_ID, node_signer=admin1_signer, node=admin1, abr_core=relay_abr, abr_executor=abr_executor, timestamp=from64x61(timestamp_1), spot=ABR_data.btc_ust_perp_spot_1, perp=ABR_data.btc_ust_perp_1, spot_64x61=convertTo64x61(ABR_data.btc_ust_perp_spot_1), perp_64x61=convertTo64x61(ABR_data.btc_ust_perp_1), epoch=1, base_rate=0.0000125, boll_width=2.0)
...
async def test_set_abr_round_2(abr_factory):
    ...
    # Set BTC_UST ABR
    (set_abr_value_tx, abr_value, abr_last_price) = await set_abr_value(market_id=BTC_UST_ID, node_signer=admin1_signer, node=admin1, abr_core=relay_abr, abr_executor=abr_executor, timestamp=from64x61(timestamp_4), spot=ABR_data.btc_ust_perp_spot_2, perp=ABR_data.btc_ust_perp_2, spot_64x61=convertTo64x61(ABR_data.btc_ust_perp_spot_2), perp_64x61=convertTo64x61(ABR_data.btc_ust_perp_2), epoch=2, base_rate=0.000025, boll_width=1.5)
    ...
    # Set BTC_USD ABR
    (set_abr_value_tx, abr_value, abr_last_price) = await set_abr_value(market_id=BTC_USD_ID, node_signer=admin1_signer, node=admin1, abr_core=relay_abr, abr_executor=abr_executor, timestamp=from64x61(timestamp_4), spot=ABR_data.btc_usd_perp_spot_2, perp=ABR_data.btc_usd_perp_2, spot_64x61=convertTo64x61(ABR_data.btc_usd_perp_spot_2), perp_64x61=convertTo64x61(ABR_data.btc_usd_perp_2), epoch=2, base_rate=0.000025, boll_width=1.5)
    ...
    # Set ETH_USD ABR
    (set_abr_value_tx, abr_value, abr_last_price) = await set_abr_value(market_id=ETH_USD_ID, node_signer=admin1_signer, node=admin1, abr_core=relay_abr, abr_executor=abr_executor, timestamp=from64x61(timestamp_4), spot=ABR_data.eth_usd_perp_spot_2, perp=ABR_data.eth_usd_perp_2, spot_64x61=convertTo64x61(ABR_data.eth_usd_perp_spot_2), perp_64x61=convertTo64x61(ABR_data.eth_usd_perp_2), epoch=2, base_rate=0.000025, boll_width=1.5)
