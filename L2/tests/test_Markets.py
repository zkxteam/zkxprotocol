...
async def adminAuth_factory():
    ...
    await signer1.send_transaction(admin1,asset.contract_address, 'addAsset', [ str_to_felt("32f0406jz7qj8"), str_to_felt("ETH"), str_to_felt("Ethereum"), 1, 0])
    await signer1.send_transaction(admin1,asset.contract_address, 'addAsset', [ str_to_felt("32f0406jz7qj7"), str_to_felt("USDC"), str_to_felt("USDCoin"), 0, 1])
    await signer1.send_transaction(admin1,asset.contract_address, 'addAsset', [ str_to_felt("32f0406jz7qj6"), str_to_felt("DOT"), str_to_felt("Polkadot"), 0, 0])
