...
async def adminAuth_factory():
    ...
    await signer1.send_transaction(admin1,asset.contract_address, 'addAsset', [ str_to_felt("32f0406jz7qj8"), str_to_felt("ETH"), str_to_felt("Ethereum"), 1, 0, 18, 0, 1, 1, 10, 1, 5, 3, 1, 1, 1, 100, 1000, 10000])
    await signer1.send_transaction(admin1,asset.contract_address, 'addAsset', [ str_to_felt("32f0406jz7qj7"), str_to_felt("USDC"), str_to_felt("USDCoin"), 0, 1, 6, 0, 1, 1, 10, 1, 5, 3, 1, 1, 1, 100, 1000, 10000])
    await signer1.send_transaction(admin1,asset.contract_address, 'addAsset', [ str_to_felt("32f0406jz7qj6"), str_to_felt("DOT"), str_to_felt("Polkadot"), 0, 0, 10, 0, 1, 1, 10, 1, 5, 3, 1, 1, 1, 100, 1000, 10000])
...
async def test_add_new_tradable_market_non_tradable_asset(adminAuth_factory):
    ...
    assert_revert(lambda: signer3.send_transaction(user1,market.contract_address, 'addMarket', [ str_to_felt("32f0406jz7qk1"), str_to_felt("32f0406jz7qj6"), str_to_felt("32f0406jz7qj7"), 1, 1]))
...
async def test_add_new_market_unauthorized_user(adminAuth_factory):
    ...
    assert_revert(lambda: signer3.send_transaction(user1,market.contract_address, 'addMarket', [ str_to_felt("32f0406jz7qk1"), str_to_felt("32f0406jz7qj8"), str_to_felt("32f0406jz7qj7"), 1, 1]))
...
async def test_modify_leverage_unauthorized_user(adminAuth_factory):
    ...
    assert_revert(lambda: signer1.send_transaction(admin1,market.contract_address, 'modifyLeverage', [ str_to_felt("32f0406jz7qk1"), 2]))
...
async def test_modify_tradable_unauthorized_user(adminAuth_factory):
    ...
    assert_revert(lambda: signer1.send_transaction(admin1,market.contract_address, 'modifyLeverage', [ str_to_felt("32f0406jz7qk1"), 0]))
...
async def test_remove_market_unauthorized_user(adminAuth_factory):
    ...
    assert_revert(lambda: signer1.send_transaction(admin1,market.contract_address, 'removeMarket', [ str_to_felt("32f0406jz7qk1")]))
