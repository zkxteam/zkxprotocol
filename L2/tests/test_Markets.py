...
async def test_add_new_market_invalid_leverage(adminAuth_factory):
    ...
    await assert_revert(signer1.send_transaction(admin1, market.contract_address, 'add_market', [
        DEFAULT_MARKET_ID, str_to_felt("32f0406jz7qj8"), str_to_felt("32f0406jz7qj7"), 1, 0, 60, 1, 1, 10, to64x61(1), to64x61(1), to64x61(3), 5, 1, 1, 100, 1000, 10000] + prepare_starknet_string(DEFAULT_LINK_1)),
