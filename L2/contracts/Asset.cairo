...
func removeAsset{
    ...
    asset.write(id = id, value = Asset(ticker = 0, short_name = 0, tradable = 0, collateral = 0, metadata_id = 0, tick_size = 0, 
...
func modify_core_settings{
    ...
    metadata_id = metadata_id, tick_size = _asset.tick_size, step_size = _asset.step_size, minimum_order_size = _asset.minimum_order_size, 
...
incremental_position_size: felt, baseline_position_size: felt, maximum_position_size: felt) :
    ...
    collateral = _asset.collateral, metadata_id = _asset.metadata_id, tick_size = tick_size, step_size = step_size, minimum_order_size = minimum_order_size, 
