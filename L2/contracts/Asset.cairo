...
func get_icon_link{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (icon_link_len, icon_link) = StringLib.read_string(type_=ICON_LINK_TYPE, id_=id);
...
func get_metadata_link{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (metadata_link_len, metadata_link) = StringLib.read_string(type_=METADATA_LINK_TYPE, id_=id);
...
func add_asset{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    StringLib.save_string(
        type_=ICON_LINK_TYPE, 
        id_=id_, 
        string_len_=icon_link_len_,
        string_chars=icon_link_
    )
    StringLib.save_string(
        type_=METADATA_LINK_TYPE, 
        id_=id_, 
        string_len_=metadata_link_len,
        string_chars=metadata_link_
    )
...
func remove_asset{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    // Delete asset links
    StringLib.remove_existing_string(type_=ICON_LINK_TYPE, id_=id_to_remove_)
    StringLib.remove_existing_string(type_=METADATA_LINK_TYPE, id_=id_to_remove_)
...
func modify_core_settings{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    id_: felt, short_name_: felt, tradable_: felt, collateral_: felt
) {
    alloc_locals;
...
// @param asset_id_ - ID of Asset to be updated
// @param icon_link_len_ - length of a link
// @param icon_link_ - link characters
@external
func update_icon_link{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    StringLib.remove_existing_string(type_=ICON_LINK_TYPE, id_=asset_id_);
    StringLib.save_string(
        type_=ICON_LINK_TYPE, 
        id_=asset_id_, 
        string_len_=icon_link_len_,
    ...
    asset_icon_link_update.emit(asset_id_);
    return ();
}
...
func update_metadata_link{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    StringLib.remove_existing_string(type_=METADATA_LINK_TYPE, id_=asset_id_);
    StringLib.save_string(
        type_=METADATA_LINK_TYPE, 
        id_=asset_id_, 
        string_len_=metadata_link_len_,
        string_chars=metadata_link_
    );
    asset_metadata_link_update.emit(asset_id_);
    return ();
}
