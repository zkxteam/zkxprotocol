...
from contracts.Constants import L1_ZKX_Address_INDEX, ManageAssets_ACTION
...
func add_asset{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    // Save asset links
    StringLib.save_string(type=ICON_LINK_TYPE, id=id, string_len=icon_link_len, string=icon_link);
    StringLib.save_string(
        type=METADATA_LINK_TYPE, id=id, string_len=metadata_link_len, string=metadata_link
    );
...
func remove_asset{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    asset_by_id.write(
        id_to_remove,
        Asset(id=0, asset_version=0, short_name=0, is_tradable=0, is_collateral=0, token_decimal=0),
    );
...
func modify_core_settings{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    verify_asset_manager_authority();
    verify_asset_id_exists(id, should_exist_=TRUE);
    with_attr error_message("Asset: is_tradable & is_collateral must be bool") {
    ...
    // Emit event
    let (caller_address) = get_caller_address();
    asset_core_settings_update.emit(asset_id=id, caller_address=caller_address);
...
func update_icon_link{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    StringLib.save_string(type=ICON_LINK_TYPE, id=asset_id, string_len=link_len, string=link);
...
func update_metadata_link{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    StringLib.save_string(type=METADATA_LINK_TYPE, id=asset_id, string_len=link_len, string=link);
...
func verify_asset_manager_authority{
