...
const W_CALCULATION_IN_PROGRESS = 1;
const W_CALCULATION_COMPLETED = 2;
const TRADER_SCORE_CALCULATION_IN_PROGRESS = 3;
const TRADER_SCORE_CALCULATION_COMPLETED = 4;
const REWARD_DISTRIBUTION_IN_PROGRESS = 5;
const REWARD_DISTRIBUTION_COMPLETED = 6;
