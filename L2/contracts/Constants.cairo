...
const WITHDRAWAL_INITIATED = 1;
const WITHDRAWAL_SUCCEEDED = 2;
...
const W_CALCULATION_IN_PROGRESS = 0;
const TRADER_SCORE_CALCULATION_IN_PROGRESS = 1;
const REWARD_DISTRIBUTION_IN_PROGRESS = 2;
const REWARD_DISTRIBUTION_COMPLETED = 3;
