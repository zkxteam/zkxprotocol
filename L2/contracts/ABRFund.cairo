...
@event
func deposit_ABR_called(order_id : felt, market_id : felt, amount : felt, timestamp : felt):
end

# Event emitted whenever withdraw() is called
@event
func withdraw_ABR_called(order_id : felt, market_id : felt, amount : felt, timestamp : felt):
end
...
func deposit{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    order_id_ : felt, market_id_ : felt, amount_ : felt
):
    ...
    deposit_ABR_called.emit(order_id=order_id_,market_id=market_id_, amount=amount_, timestamp = block_timestamp)
...
func withdraw{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    # Get the latest block
    let (block_timestamp) = get_block_timestamp()
    withdraw_ABR_called.emit(order_id=order_id_,market_id=market_id_, amount=amount_, timestamp = block_timestamp)
