...
@event
func trade_recorded(season_id: felt, pair_id: felt, trader_address: felt, order_type: felt, order_size: felt, order_price: felt){
}
...
func get_num_trades_in_day{
    ...
    with_attr error_message("Day number should be less than current day number/total tradable days") {
...
func get_frequencies{
    ...
    get_frequencies(season_id_, pair_id_, total_frequencies - 1, current_index_ + 1, frequency_list + 1);
    return ();
}
