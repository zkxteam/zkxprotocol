...
func modify_tradable{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (inner_address) = get_inner_contract();
    IMarkets.modify_tradable(
        contract_address=inner_address, 
        market_id_=market_id_, 
        is_tradable_=is_tradable_
    );
    return ();
}
...
func modify_archived_state{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (inner_address) = get_inner_contract();
    IMarkets.modify_archived_state(
        contract_address=inner_address,
        market_id_=market_id_,
...
func modify_trade_settings{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    IMarkets.modify_trade_settings(
        ...
        minimum_order_size_=minimum_order_size_,
        minimum_leverage_=minimum_leverage_,
        maximum_leverage_=maximum_leverage_,
        currently_allowed_leverage_=currently_allowed_leverage_,
        maintenance_margin_fraction_=maintenance_margin_fraction_,
        initial_margin_fraction_=initial_margin_fraction_,
        incremental_initial_margin_fraction_=incremental_initial_margin_fraction_,
        incremental_position_size_=incremental_position_size_,
        baseline_position_size_=baseline_position_size_,
        maximum_position_size_=maximum_position_size_
    );
    return ();
}
...
func change_max_leverage{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (inner_address) = get_inner_contract();
    IMarkets.change_max_leverage(
        contract_address=inner_address, 
        new_max_leverage_=new_max_leverage_
    );
    return ();
}
...
func change_max_ttl{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (inner_address) = get_inner_contract();
    IMarkets.change_max_ttl(
        contract_address=inner_address, 
        new_max_ttl_=new_max_ttl_
    );
    return ();
}
...
func get_market{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(market_id_: felt) -> (
    ...
    let (inner_address) = get_inner_contract();
    let (currMarket) = IMarkets.get_market(
        contract_address=inner_address, 
        market_id_=market_id_
    );
    return (currMarket,);
...
func get_maintenance_margin{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (inner_address) = get_inner_contract();
    let (maintenance_margin) = IMarkets.get_maintenance_margin(
        contract_address=inner_address, 
        market_id_=market_id_
    );
